"use client";
import React from "react"; // Tetap dibutuhkan agar JSX bisa digunakan

/**
 * Hero Section matching the image, featuring a large background and centered title.
 */
export function Hero() { // Sama seperti Sidebar: pakai 'export function', bukan export default
  return (
    <header
    ...
    >
      ...
      {/* Konten dengan latar belakang putih semi-transparan */}
      <div className="relative z-10 max-w-4xl mx-auto bg-white/90 rounded-xl shadow-2xl p-8 md:p-12">
        {/* Wrapper AnimateInView dihapus untuk mengatasi error impor */}
        ...
        <p className="mt-6 text-base md:text-lg text-gray-700 font-body leading-relaxed max-w-3xl mx-auto">
          ...
          telekomunikasi, dan telegraf di Indonesia sejak zaman kolonial Belanda.
        </p>
        {/* </AnimateInView> */}
      </div>
    </header>
